        ...
        public async void Run([EventGridTrigger] EventGridEvent eventGridEvent, ILogger log)
        {
            try
            {
                ...
                else if (eventGridEvent != null && eventGridEvent.Data != null)
                {
                    ...
                    updateProperty.AppendAdd("current_channel_name" , current_channel_name.Value<int>());
                        ...
                        updateProperty.AppendAdd("volume_mute" , volume_mute.Value<int>());
                        ...
                        updateProperty.AppendAdd("display_settings_color_temperature" , display_settings_color_temperature.Value<int>());
                        updateProperty.AppendAdd("active_input" , active_input.Value<int>());
                        updateProperty.AppendAdd("audio_output" , audio_output.Value<int>());
                        updateProperty.AppendAdd("network_status_connected" , network_status_connected.Value<int>());
                        updateProperty.AppendAdd("network_status_wifi_strength" , network_status_wifi_strength.Value<int>());
                        updateProperty.AppendAdd("tv_components_main_board_temperature" , tv_components_main_board_temperature.Value<int>());
                        updateProperty.AppendAdd("tv_components_power_supply_voltage" , tv_components_power_supply_voltage.Value<int>());
                        updateProperty.AppendAdd("tv_components_power_supply_current" , tv_components_power_supply_current.Value<int>());
                        updateProperty.AppendAdd("tv_components_display_panel_resolution" , tv_components_display_panel_resolution.Value<int>());
                        ...
                        updateProperty.AppendAdd("tv_components_audio_system_mute" , tv_components_audio_system_mute.Value<int>());
                        updateProperty.AppendAdd("tv_components_wifi_module_connected" , tv_components_wifi_module_connected.Value<int>());
